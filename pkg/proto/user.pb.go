...
var file_user_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0x36, 0x0a, 0x0b, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x4c, 0x69, 0x73,
	0x74, 0x12, 0x27, 0x0a, 0x08, 0x69, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65,
	0x52, 0x08, 0x69, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x73, 0x22, 0x85, 0x01, 0x0a, 0x07, 0x49,
	...
	0x6c, 0x61, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20,
	...
	0x75, 0x73, 0x22, 0x34, 0x0a, 0x09, 0x55, 0x50, 0x6c, 0x61, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x12,
	...
	0x73, 0x32, 0x81, 0x06, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x33, 0x0a, 0x0f, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65,
	0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x12, 0x12, 0x2e, 0x70, 0x62, 0x2e, 0x49, 0x6e, 0x76,
	0x6f, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x70, 0x62,
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x73, 0x12, 0x06, 0x2e, 0x70,
	0x62, 0x2e, 0x49, 0x44, 0x1a, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*InvoiceList)(nil),                // 4: pb.InvoiceList
	(*Invoice)(nil),                    // 5: pb.Invoice
	(*UPlanList)(nil),                  // 6: pb.UPlanList
	(*USubscription)(nil),              // 7: pb.USubscription
	(*UserStatsResponse)(nil),          // 8: pb.UserStatsResponse
	(*UserSubmissionResponse)(nil),     // 9: pb.UserSubmissionResponse
	(*UserSubmissionRequest)(nil),      // 10: pb.UserSubmissionRequest
	(*UserTestCase)(nil),               // 11: pb.UserTestCase
	(*UserProblemWithTestCases)(nil),   // 12: pb.UserProblemWithTestCases
	(*UserTestcaseResponse)(nil),       // 13: pb.UserTestcaseResponse
	(*UserProblemId)(nil),              // 14: pb.UserProblemId
	(*UserProblem)(nil),                // 15: pb.UserProblem
	(*UserProblemList)(nil),            // 16: pb.UserProblemList
	(*Signup)(nil),                     // 17: pb.Signup
	(*OTP)(nil),                        // 18: pb.OTP
	(*Login)(nil),                      // 19: pb.Login
	(*Response)(nil),                   // 20: pb.Response
	(*ID)(nil),                         // 21: pb.ID
	(*Profile)(nil),                    // 22: pb.Profile
	(*UserNoParam)(nil),                // 23: pb.UserNoParam
	(*Password)(nil),                   // 24: pb.Password
	(*UserList)(nil),                   // 25: pb.UserList
	(*timestamppb.Timestamp)(nil),      // 26: google.protobuf.Timestamp
}
var file_user_proto_depIdxs = []int32{
	5,  // 0: pb.InvoiceList.invoices:type_name -> pb.Invoice
	7,  // 1: pb.UPlanList.plans:type_name -> pb.USubscription
	0,  // 2: pb.UserSubmissionResponse.status:type_name -> pb.UserSubmissionResponse.Status
	15, // 3: pb.UserProblemWithTestCases.problem:type_name -> pb.UserProblem
	11, // 4: pb.UserProblemWithTestCases.test_cases:type_name -> pb.UserTestCase
	1,  // 5: pb.UserTestcaseResponse.status:type_name -> pb.UserTestcaseResponse.Status
	12, // 6: pb.UserTestcaseResponse.data:type_name -> pb.UserProblemWithTestCases
	15, // 7: pb.UserProblemList.problems:type_name -> pb.UserProblem
	2,  // 8: pb.Response.status:type_name -> pb.Response.Status
	26, // 9: pb.Profile.membership_Expiry_Date:type_name -> google.protobuf.Timestamp
	22, // 10: pb.UserList.users:type_name -> pb.Profile
	17, // 11: pb.UserService.UserSignup:input_type -> pb.Signup
	18, // 12: pb.UserService.VerifyUser:input_type -> pb.OTP
	19, // 13: pb.UserService.UserLogin:input_type -> pb.Login
	21, // 14: pb.UserService.ViewProfile:input_type -> pb.ID
	22, // 15: pb.UserService.EditProfile:input_type -> pb.Profile
	24, // 16: pb.UserService.ChangePassword:input_type -> pb.Password
	21, // 17: pb.UserService.BlockUser:input_type -> pb.ID
	21, // 18: pb.UserService.UnBlockUser:input_type -> pb.ID
	23, // 19: pb.UserService.GetAllUsers:input_type -> pb.UserNoParam
	23, // 20: pb.UserService.UserGetAllProblems:input_type -> pb.UserNoParam
	14, // 21: pb.UserService.UserGetProblemWithTestCases:input_type -> pb.UserProblemId
	10, // 22: pb.UserService.SubmitCode:input_type -> pb.UserSubmissionRequest
	21, // 23: pb.UserService.GetUserStats:input_type -> pb.ID
	23, // 24: pb.UserService.UserGetAllPlans:input_type -> pb.UserNoParam
	3,  // 25: pb.UserService.GenerateInvoice:input_type -> pb.InvoiceRequest
	21, // 26: pb.UserService.GetUserInvoices:input_type -> pb.ID
	20, // 27: pb.UserService.UserSignup:output_type -> pb.Response
	20, // 28: pb.UserService.VerifyUser:output_type -> pb.Response
	20, // 29: pb.UserService.UserLogin:output_type -> pb.Response
	22, // 30: pb.UserService.ViewProfile:output_type -> pb.Profile
	22, // 31: pb.UserService.EditProfile:output_type -> pb.Profile
	20, // 32: pb.UserService.ChangePassword:output_type -> pb.Response
	20, // 33: pb.UserService.BlockUser:output_type -> pb.Response
	20, // 34: pb.UserService.UnBlockUser:output_type -> pb.Response
	25, // 35: pb.UserService.GetAllUsers:output_type -> pb.UserList
	16, // 36: pb.UserService.UserGetAllProblems:output_type -> pb.UserProblemList
	13, // 37: pb.UserService.UserGetProblemWithTestCases:output_type -> pb.UserTestcaseResponse
	9,  // 38: pb.UserService.SubmitCode:output_type -> pb.UserSubmissionResponse
	8,  // 39: pb.UserService.GetUserStats:output_type -> pb.UserStatsResponse
	6,  // 40: pb.UserService.UserGetAllPlans:output_type -> pb.UPlanList
	20, // 41: pb.UserService.GenerateInvoice:output_type -> pb.Response
	4,  // 42: pb.UserService.GetUserInvoices:output_type -> pb.InvoiceList
